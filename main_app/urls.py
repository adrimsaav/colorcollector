...
urlpatterns = [
  ...
  path('colors/<int:color_id>/assoc_star/<int:star_id>', views.assoc_star, name='assoc_star'),
  path('colors/<int:color_id>/unassoc_star/<int:star_id>', views.unassoc_star, name='unassoc_star'),
